...
//Declare the private variables for the employee's name, salary, and age.
	...
	// Create the getter and setter methods for the employee's name.
	...
	// Create the getter and setter methods for the employee's salary.
	...
	// Create the getter and setter methods for the employee's age.
	public int getAge() {
	 return age;
	}
...
public class EmployeeClass extends Thread{ 
    ...
    public void addRandomEmployees() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            emp.setSalary(rand.nextInt(100000) + 50000); // Random salary between 50000 and 149999
